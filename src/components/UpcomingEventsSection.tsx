          ...
          {UPCOMING_EVENTS.map((event) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative bg-cw-charcoal/90 border rounded-3xl p-7 md:p-8 flex flex-col justify-between hover:shadow-2xl transition-all duration-500 overflow-hidden ${
                  isGold 
